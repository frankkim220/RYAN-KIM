			...
			public void actionPerformed(ActionEvent e) {
				...
				if (type.equals("Member"))
				{
					for (Member member: memberList)	
					{
						...
						{
							MemberUpdate memUp = new MemberUpdate(member, memberList);
							memUp.setVisible(true);
						}
					}
				}
				else
				{
					for (Student student: studentList)
					{
						...
						{
							StudentUpdate stuUp = new StudentUpdate(student, studentList);
							stuUp.setVisible(true);
						}
					}
				}
			}
